...
class Game:
    def __init__(self, root):
        ...
        self.snake_image = Image.open("snake2.png").resize((30, 30), Image.Resampling.LANCZOS)  # Resize image
        self.snake_image_tk = ImageTk.PhotoImage(self.snake_image)

        self.ladder_image = Image.open("ladder.png").resize((30, 30), Image.Resampling.LANCZOS)  # Resize image
    ...
    def draw_snake(self, start, end):
        ...
        # Adjust image position to be centered within the square
